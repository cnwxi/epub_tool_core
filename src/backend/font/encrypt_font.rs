...
use crate::backend::{epub::EpubWorkspace, EpubTask, TaskOutcome, TaskUpdate};
use crate::encoding::{decode_epub_text, encode_epub_text, text_kind_for_path, TextKind};
use crate::task::{FontTaskOptions, TaskOptions, TaskType};
use rand::Rng;
use regex::Regex;
use std::{
...
mod tests {
    ...
    use crate::backend::font::font_style::{compute_font_map, parse_font_faces, FontFaceResolver};
